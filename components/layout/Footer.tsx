...
const trustBadges = [
  { icon: Coffee, text: "FRESH ROASTED DAILY" },
  { icon: Leaf, text: "LOCALLY SOURCED" },
  { icon: Heart, text: "WARM WELCOME" },
];
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-1 text-center sm:justify-between sm:text-left">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-semibold uppercase text-stone-500">Find us</span>
              <div className="flex gap-1">
                ...
                >
                  <svg className="h-3 w-3" fill="currentColor" viewBox="0 0 24 24">
                    <path fillRule="evenodd" d="M12.315 2c2.43 0 2.784.013 3.808.06 1.064.049 1.791.218 2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465 2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049 1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902 0 01-1.772 1.153c-.636.247-1.363.416-2.427.465-1.067.048-1.407.06-4.123.06h-.08c-2.643 0-2.987-.012-4.043-.06-1.064-.049-1.791-.218-2.427-.465a4.902 4.902 0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.048-1.067-.06-1.407-.06-4.123v-.08c0-2.643.012-2.987.06-4.043.049-1.064.218-1.791.465-2.427a4.902 4.902 0 011.153-1.772A4.902 4.902 0 015.45 2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 11.685 2h.63zm0 5.25a5.625 5.625 0 100 11.25 5.625 5.625 0 000-11.25zM12 16.5a4.5 4.5 0 110-9 4.5 4.5 0 010 9z" clipRule="evenodd" />
              ...
              <span className="text-[10px] text-stone-500">123 Cloud St</span>
            </div>
            ...
            <div className="flex items-center gap-2 text-[10px] text-stone-600">
              ...
              {isAdmin && (
                <>
                  <span className="text-stone-400">·</span>
                  <Link href="/admin" className="hover:text-stone-800">Admin</Link>
                </>
              )}
            </div>
          </div>
